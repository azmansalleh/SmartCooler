...
from SpeechAndVoice.audio_recorder import AudioRecorder
from SpeechAndVoice import voice_utils as utils
...
def run(audio_file_path):
    ...
    api_key = "73efbc137b324049b5ad9b4eca584531"#sys.argv[1]
    language = "en-US"#sys.argv[2]
    response_format = "detailed" #sys.argv[3]
    recognition_mode = "interactive"#sys.argv[4]
